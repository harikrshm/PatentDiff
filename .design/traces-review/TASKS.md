...
## Core UI
- [x] **T1 · Trace reader shows the tool's output + remove "Your reading"**:
...
- [x] **T2 · Review tab (`/eval/review`) + nav item**: New Dash page
...
## Review
- [x] **Design review**: `/design-review` against the brief — `/eval/traces`
